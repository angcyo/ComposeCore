...
abstract class BaseAccService : AccessibilityService() {
    ...
    companion object {
        ...
        /**无障碍服务是否连接*/
        val accServiceConnectedData = vmData(false)
    }
    ...
    override fun onServiceConnected() {
        ...
        isServiceConnected = true/*serviceInfo.apply {
        ...
        lastService = this
        accServiceConnectedData.updateValue(true)
    }

    /**
     * 当收到应用发过来的[android.view.accessibility.AccessibilityEvent]无障碍事件
     * 无障碍的核心事件回调
     * */
    ...
    override fun onDestroy() {
        ...
        lastService = null
        accServiceConnectedData.updateValue(false)
    }
    ...
    fun pressLocation(position: Point) {
        ...
        builder.addStroke(GestureDescription.StrokeDescription(p, 0, 100L))
