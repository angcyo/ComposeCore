...
import com.angcyo.compose.basics.unit.have
...
object AccPermission {
    ...
    /**打开悬浮窗设置页面*/
    fun openOverlaysActivity(context: Context) {/*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    /*fun getEnabledAccessibilityGesturesAppList(
        context: Context = app(), filterSelf: Boolean = true
    ): List<AppBean> {
